...
class LinkLexTest < Test::Unit::TestCase
  ...
  def test_external_incomplete
    ...
    assert_equal('Hello', lexer.result[4].value)
  end
  ...
  def test_internal_image_frame
    ...
    assert_equal(:link_attribute, lexer.result[3].type)
    assert_equal(:text, lexer.result[4].type)
    assert_equal('frame', lexer.result[4].value)
    assert_equal(:link_attribute, lexer.result[5].type)
    assert_equal(:text, lexer.result[6].type)
  ...
  def test_internal_image_thumb
    ...
    assert_equal(:link_attribute, lexer.result[3].type)
    assert_equal(:text, lexer.result[4].type)
    assert_equal('thumb', lexer.result[4].value)
    assert_equal(:link_attribute, lexer.result[5].type)
    assert_equal(:text, lexer.result[6].type)
    assert_equal('Test PNG', lexer.result[6].value)
    assert_equal(:link_end, lexer.result[7].type)
  ...
  def test_internal_image_width
    ...
    assert_equal(:link_attribute, lexer.result[3].type)
    assert_equal(:text, lexer.result[4].type)
    assert_equal('100px', lexer.result[4].value)
    assert_equal(:link_attribute, lexer.result[5].type)
    assert_equal(:text, lexer.result[6].type)
    assert_equal('Test PNG', lexer.result[6].value)
    assert_equal(:link_end, lexer.result[7].type)
  ...
  def test_internal_image_left
    ...
    assert_equal(:link_attribute, lexer.result[3].type)
    assert_equal(:text, lexer.result[4].type)
    assert_equal('left', lexer.result[4].value)
    assert_equal(:link_attribute, lexer.result[5].type)
    assert_equal(:text, lexer.result[6].type)
    assert_equal('Test PNG', lexer.result[6].value)
    assert_equal(:link_end, lexer.result[7].type)
