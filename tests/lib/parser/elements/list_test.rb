...
class ListParseTest < Test::Unit::TestCase
  ...
  def test_ol_dl_dt_dn
    ...
    assert_equal(2, parser.result.children[0].children[0].children.length)
    assert_equal(:br, parser.result.children[0].children[0].children[0].type)
    assert_equal(:dl, parser.result.children[0].children[0].children[1].type)
    assert_equal(2, parser.result.children[0].children[0].children[1].children.length)
    assert_equal(:dt, parser.result.children[0].children[0].children[1].children[0].type)
    assert_equal(1, parser.result.children[0].children[0].children[1].children[0].children.length)
    assert_equal(:text, parser.result.children[0].children[0].children[1].children[0].children[0].type)
    assert_equal(' ABC', parser.result.children[0].children[0].children[1].children[0].children[0].value)
    assert_equal(:dd, parser.result.children[0].children[0].children[1].children[1].type)
    assert_equal(1, parser.result.children[0].children[0].children[1].children[1].children.length)
    assert_equal(:text, parser.result.children[0].children[0].children[1].children[1].children[0].type)
    assert_equal(' DEF', parser.result.children[0].children[0].children[1].children[1].children[0].value)
  end
