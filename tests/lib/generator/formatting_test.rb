...
class FormattingGenTest < Test::Unit::TestCase
  ...
  def test_short2
    gen = WikiThat::HTMLGenerator.new('\'\'thing\'', 'wiki', 'BOB', 'sub/folder', 'media/folder')
    gen.generate
    assert_true(gen.success?, 'Generation should have succeeded')
  ...
  def test_italic
    gen = WikiThat::HTMLGenerator.new('\'\'italic things\'\'', 'wiki', 'BOB', 'sub/folder', 'media/folder')
    gen.generate
    assert_true(gen.success?, 'Generation should have succeeded')
  ...
  def test_italic_inline
    gen = WikiThat::HTMLGenerator.new('not \'\'italic things\'\' not', 'wiki', 'BOB', 'sub/folder', 'media/folder')
    gen.generate
    assert_equal('<p>not <i>italic things</i> not</p>', gen.result)
  end

  def test_bold
    gen = WikiThat::HTMLGenerator.new('\'\'\'bold things\'\'\'', 'wiki', 'BOB', 'sub/folder', 'media/folder')
    gen.generate
    assert_true(gen.success?, 'Generation should have succeeded')
  ...
  def test_bold_inline
    gen = WikiThat::HTMLGenerator.new('not \'\'\'bold things\'\'\' not', 'wiki', 'BOB', 'sub/folder', 'media/folder')
    gen.generate
    assert_true(gen.success?, 'Generation should have succeeded')
  ...
  def test_both
    gen = WikiThat::HTMLGenerator.new('\'\'\'\'\'both things\'\'\'\'\'', 'wiki', 'BOB', 'sub/folder', 'media/folder')
    gen.generate
    assert_true(gen.success?, 'Generation should have succeeded')
  ...
  def test_both_inline
    gen = WikiThat::HTMLGenerator.new('not \'\'\'\'\'both things\'\'\'\'\' not', 'wiki', 'BOB', 'sub/folder', 'media/folder')
    gen.generate
    assert_true(gen.success?, 'Generation should have succeeded')
  ...
  def test_link
    gen = WikiThat::HTMLGenerator.new('\'\'[https://example.com]\'\'', 'wiki', 'BOB', 'sub/folder', 'media/folder')
    gen.generate
    assert_true(gen.success?, 'Generation should have succeeded')
