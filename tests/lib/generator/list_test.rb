...
class ListGenTest < Test::Unit::TestCase
  ...
  def test_ul_li
    gen = WikiThat::HTMLGenerator.new('*A', 'wiki', 'BOB', 'sub/folder')
    gen.generate
  ...
  def test_ol_ul
    ...
    assert_equal('<ol><li><ul><li> ABC</li></ul></li></ol>', gen.result, 'Unordered List should have been generated')
  end
  ...
  def test_ul_ol_ul
    ...
    assert_equal('<ul><li><ol><li> AB</li><li><ul><li> ABC</li></ul></li></ol></li></ul>', gen.result, 'Unordered List should have been generated')
  end
  ...
  def test_ol_dl_dt_dn
    ...
    assert_equal('<ol><li><dl><dt> ABC</dt><dd> DEF</dd></dl></li></ol>', gen.result, 'Unordered List should have been generated')
  end
